      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-16">
          {stats.map((stat, index) => (
            <AppCard
              key={index}
              className="text-center border-0 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm"
        ...
        <AppCard
          className="max-w-4xl mx-auto mb-16 border-0 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm"
          title={t("mission.title")}
          headerClassName="text-3xl mb-4 text-center"
        >
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((feature, index) => (
              <AppCard
                key={index}
                className="text-center border-0 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm hover:shadow-xl transition-shadow"
                contentClassName="p-6"
              >
        ...
        <AppCard
          className="border-0 bg-gradient-to-r from-blue-500 to-purple-600 text-white text-center"
